...
void TileType::putInfo(std::stringstream& ss, int& tabs)
{
...
bool TileType::isTechnical() { return value&HexMasks::TECHNICAL; }
...
void TileType::setTechnical( bool p_technical )
{
	value = value|( ((uint64_t)p_technical)<<63 );
}
