...
private:
	...
	NCH_Color skyColor;
	NCH_Color sky[4] = {
		NCH_Color(0, 0, 128),		//Midnight blue		Midnight 	(10hrs, 21:00-7:00)
		NCH_Color(240, 160, 20),	//Light orange		Sunrise 	(2hrs, 8:00)
		NCH_Color(135, 206, 250),	//Light sky blue	Midday 		(10hrs, 9:00-19:00)
		NCH_Color(240, 120, 20)		//Red orange		Sunset 		(2hrs, 20:00)
	};
