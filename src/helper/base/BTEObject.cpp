...
void BTEObject::setType(int p_type)
{
    if(type==Type::none) {
        ...
        nch::Log::warn(__PRETTY_FUNCTION__, "Tried to set the type of an object more than once");
    }
}
void BTEObject::setSubType(int p_subtype)
{
    ...
    nch::Log::warn(__PRETTY_FUNCTION__, "Tried to set the type of an object to an invalid subtype");
}
...
void BTEObject::setID(int p_id)
{
    if(id==-1) {
        ...
        nch::Log::warn(__PRETTY_FUNCTION__, "Tried to set ID of an object more than once");
    }
}
