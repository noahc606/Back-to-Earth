...
ColorSelector::ColorSelector(Window* parentWindow, int x, int y, nch::Color col, int id)
...
ColorSelector(parentWindow, x, y, nch::Color(), id){}
...
void ColorSelector::buildTexes()
{
    ...
    wd.setPanelColor('a', nch::Color(0, 0, 0, 0));
